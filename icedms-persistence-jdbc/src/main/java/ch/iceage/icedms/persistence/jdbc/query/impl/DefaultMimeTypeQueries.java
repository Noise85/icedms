 ...
 */
@Component
public class DefaultMimeTypeQueries extends AbstractGenericQueries<MimeType> implements MimeTypeQueries {
	...
	@Override
	public String getAll(MimeType criteria, FetchType oneToMany, FetchType manyToOne) {
