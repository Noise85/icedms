 ...
 */
@Component
public class DefaultDocumentGroupQueries extends AbstractGenericQueries<DocumentGroup> 
														implements DocumentGroupQueries {
	...
	@Override
	public String getAll(DocumentGroup criteria, FetchType oneToMany, FetchType manyToOne) {
